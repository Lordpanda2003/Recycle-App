  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Expanded(
          flex: 3, // Allocate more space for the image (roughly 60% of available height)
          child: ClipPath(
            ...
            child: SizedBox(
              ...
              child: Image.network(
                ...
                alignment: Alignment.bottomCenter, // Focus on the bottom part of the image
        ...
        Expanded(
          flex: 2, // Allocate remaining space for text and description (roughly 40%)
          child: Column(
